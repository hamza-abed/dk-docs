...
[
  {
    ...
    "status": "in_progress",
    "address_text": "10 Rue de la Paix, Paris",
...
|-----------|--------|---------|
| Mission | UUID v4 | `c3d4e5f6-a7b8-4012-8def-123456789012` |
| Utilisateur / Opérateur | UUID v4 | `f1e2d3c4-b5a6-4890-abcd-ef1234567890` |
| Client | UUID v4 | `a1b2c3d4-e5f6-4890-abcd-ef1234567890` |
| Organisation | UUID v4 | `b2c3d4e5-f6a7-4901-bcde-f12345678901` |

...
<Card title="Services détaillés" icon="server">
  Description détaillée de chaque service : responsabilités, API interne, dépendances. [Voir les services](/dk-docs/architecture/services)
</Card>
